...
class ShowImage(QMainWindow):
    def __init__(self):
        ...
        self.actionSmoothing_Image.triggered.connect(self.smoothingImage)
        self.actionDeteksi_Tepi.triggered.connect(self.edgeDetection)
    ...
    def smoothingImage(self):
        ...
        plt.imshow(Img)
        # Membaca citra 'img-noise.jpg' dalam skala abu-abu
